      ...
      builder: (BuildContext context, EditClientState state) {
        ...
        return Table(
          ...
          children: <TableRow>[
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_birthAddress.translate()),
                InputValueTableCell(
            ...
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_currentCity.translate()),
                InputValueTableCell(
                  child: DelayedTableTextField(
            ...
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_currentAddress.translate()),
                InputValueTableCell(
                  child: DelayedTableTextField(
            ...
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_cityOfResidence.translate()),
                InputValueTableCell(
                  child: DelayedTableTextField(
            ...
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_residenceAddress.translate()),
                InputValueTableCell(
                  child: DelayedTableTextField(
            ...
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_citizenship.translate()),
                InputValueTableCell(
                  child: DelayedTableTextField(
