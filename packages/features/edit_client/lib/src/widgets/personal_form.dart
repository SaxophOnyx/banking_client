      ...
      builder: (BuildContext context, EditClientState state) {
        ...
        return Table(
          ...
          children: <TableRow>[
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_firstName.translate()),
                InputValueTableCell(
            ...
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_middleName.translate()),
                InputValueTableCell(
                  child: DelayedTableTextField(
            ...
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_lastName.translate()),
                InputValueTableCell(
                  child: DelayedTableTextField(
            ...
            TableRow(
              children: <Widget>[
                InputKeyTableCell(value: LocaleKeys.clients_labels_gender.translate()),
                InputValueTableCell(
